...
int main(int argc, char *argv[]){
	...
	int posX = 200, posY = 40, width = 900, height = 540;
       ...
       //     SDL_StartTextInput();
        ...
        while(SDL_PollEvent(&event) != 0){
            ...
            case SDL_MOUSEBUTTONDOWN:
              ...
              if (event.button.clicks == 1 && event.button.x >= 910 && event.button.x < 970 && event.button.y > 455 && mode_play_new[0] != 'f'){
                      ...
                      //  check_units(cont_m, cont_p, vetN, vetX, vetY, mode_player);
                       ...
                       if(divLA >= 1){
                        ...
                        if(divLA >= 1){
                            ...
                            vetFX[15] = 0.025*add_fvx;
                            vetFY[15] = py1*add_fvy;

                        }else{

                            vetFX[15] = px1*add_fvx;
                            vetFY[15] = 0.025*add_fvy;
                        }
                  ...
                  }else if(m_ang_t == 0 && event.button.clicks == 1/*event.button.state == SDL_PRESSED*/){
                  	
                  	if(addv[0] > 5 && event.button.x < 900){
                  	                	 		
                  	     m_ang_t = 1;
                  	                   	 
                  	}
                  	
                   }else if(event.button.clicks == 1/*event.button.state == SDL_PRESSED*/){
			...
			case SDL_KEYDOWN:
                ...
                }else if(event.button.clicks == 1 && mode_play_new[0] != 'f' && event.button.y < 270 && event.button.x > 900 || event.key.keysym.sym == SDLK_SPACE && mode_play_new[0] != 'f'){
				...
				}else if (event.button.clicks == 1 && mode_play_new[0] != 'f' && event.button.y > 270 && event.button.x > 900 || event.key.keysym.sym == SDLK_f && mode_play_new[0] != 'f'){
    		    ...
    		    case SDL_WINDOWEVENT:
    	           ...
    	           if(event.window.windowID == windowID){
                    ...
                    case SDL_MOUSEMOTION:{
                        ...
                        if(event.motion.x > 930 && event.motion.y > 10 && event.motion.y <= 440){
                       
                       float max_fv;
                       max_fv = 0.181818181818; // 80 / 440;
                       float val_fv;
        ...
        for(int s = 0; s < 15; s++){ 
              ...
              if(vetX[s] > 10 && vetY[s] > 10 && fabxy < 1.35){
                   cont_s++; //count ball zero mfs
               }     
          }  
          
          if(cont_play > cont_prox && fabxydft < 1.35 && count_zero == cont_s && cpy < 3){
         ...
         if(cont_play > cont_prox && count_zero == cont_s && fabxydft < 1.35 && cpy > 0){
        ...
        if(change_mode[0] == 'n' && count_zero == cont_s && cont_play > cont_prox && sttm == false && fabxydft < 1.35 && cpx == 2 && cpy > 1){    
            ...
            if(change_mode[0] == 'n'){
                ...
                if(fabxydft < 1.35 && rand_on[0] == 'n' && all_k[0] >= cont_s){
        ...
        //start show in mode off
         ...
         reset_engine(renderer, count_zero);       
